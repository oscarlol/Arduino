...
void loop()
{
  ...
  analogWrite(led5, 0);     // posar PWM del pin 11 a 0
  analogWrite(led6, 0);     // posar PWM del pin 3 a 0
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
  ...
  analogWrite(led5, 60);     // posar PWM del pin 11 a 60
  analogWrite(led6, 60);    // posar PWM del pin 3 a 125
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
  ...
  analogWrite(led6, 125);    // posar PWM del pin 3 a 125
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  ...
  analogWrite(led6, 255);    // posar PWM del pin 3 a 125   
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  ...
  analogWrite(led4, 60);     // posar PWM del pin 10 a 60
  analogWrite(led5, 60);     // posar PWM del pin 11 a 60
  analogWrite(led6, 60);     // posar PWM del pin 3 a 60
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
}
} 
