...
const byte led1 = 4;          // donar nom al pin 5 de l’Arduino
const byte led2 = 5;          // donar nom al pin 6 de l’Arduino
const byte led3 = 6;          // donar nom al pin 9 de l’Arduino
const byte led4 = 7;         // donar nom al pin 10 de l’Arduino
const byte led5 = 8;         // donar nom al pin 11 de l’Arduino
